...
from kincalib.Calibration.CalibrationEntities import CalibrationData, CircleFittingMetrics
                ...
                try:
                    ...
                    if circle_metrics.has_all_circles():
                        ...
                        m1, m2, m3 = calib.calculate_pitch_origin(
                            circle_metrics.roll1.circle,
                            circle_metrics.pitch1.circle,
                            circle_metrics.pitch2.circle,
                        )
                        # m1, m2, m3 = calib.calculate_pitch_origin(
                        ...
                        calibration_dict1 = RobotTrackerCalibration.calculate_axes_in_marker(
                            pitch_ori_T, pitch_yaw_circles, circle_metrics.roll1.circle
                        )
                        # calibration_dict1 = RobotTrackerCalibration.calculate_axes_in_marker(
                        ...
                        calibration_dict2 = RobotTrackerCalibration.calculate_fiducial_from_yaw(
                            pitch_ori_T, pitch_yaw_circles, circle_metrics.roll2.circle
                        )
                        # calibration_dict2 = RobotTrackerCalibration.calculate_fiducial_from_yaw(
                        ...
                        log.info(f"No circles at step {step}")
